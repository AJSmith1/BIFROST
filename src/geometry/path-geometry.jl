...
function straight!(spec::PathSpecBuilder; length, meta::AbstractVector = AbstractMeta[])
...
function bend!(spec::PathSpecBuilder; radius::Real, angle::Real, axis_angle::Real = 0.0,
               meta::AbstractVector = AbstractMeta[])
...
function helix!(spec::PathSpecBuilder; radius::Real, pitch::Real, turns::Real,
                axis_angle::Real = 0.0, meta::AbstractVector = AbstractMeta[])
